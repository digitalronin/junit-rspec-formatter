package com.digitalronin;

/*
 * TODO
 *   - failures are printing twice. stop that
 *   - differentiate errors and failures
 *   - output on one continuous line
 *   - break the line after every N tests
 *   - collect stats on the whole test run (tests, failure, errors, time)
 *   - output collected stats at the end of the report
 *   - output failure details at the end of the report
 *   - output error details at the end of the report
 *   - output progressively rather than after each suite
 */
...
public class RspecFormatter implements JUnitResultFormatter {

  private final String TAB_STR = "    ";

  private final String OK_STR   = ".";
  private final String FAIL_STR = "F";
  ...
  /**
   * Constructor for RspecFormatter.
   */
  public RspecFormatter() {
  ...
  public void endTest(Test test) {
    ...
    String result = failed ? FAIL_STR : OK_STR;
    output.write(result);
